    ...
    return (
        <Box flexDirection={"column"}>
            <Box flexDirection={"row"}>
                <Text color={activeField === "name" ? colors.text.primary : colors.text.muted}>Nazwa: </Text>
            ...
            <Box flexDirection={"row"}>
                <Text color={activeField === "email" ? colors.text.primary : colors.text.muted}>Email: </Text>
            ...
            <Box flexDirection={"row"}>
                <Text color={activeField === "password" ? colors.text.primary : colors.text.muted}>Hasło: </Text>
